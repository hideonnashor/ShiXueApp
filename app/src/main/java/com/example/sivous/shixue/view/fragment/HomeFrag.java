...
import com.example.sivous.shixue.utils.GlideImageLoader;
...
public class HomeFrag extends Fragment {
    ...
    private Map<List<String>, List<String>> imgAndDes;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        imgAndDes = imageService.getImgAndDes();
        images = imgAndDes.entrySet().iterator().next().getKey();
        titles = imgAndDes.entrySet().iterator().next().getValue();
